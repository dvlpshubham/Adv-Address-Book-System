...
public class AddressBookSystemTest {
    ...
    public void givenAddressBookDetails_WhenRetrieved_ShouldMachPersonsCount() throws AddressBookException {
        List<Person> list = addressBookService.readAddressBookData(AddressBookService.IOService.DB_IO);
        Assert.assertEquals(2, list.size());
    }

    @Test
    public void givenAddressBookDetails_WhenUpdated_ShouldSyncWithDB() throws AddressBookException {
        List<Person> data = addressBookService.readAddressBookData(AddressBookService.IOService.DB_IO);
    ...
    public void givenAddressBookDetails_WhenRetrieved_ForGivenRange_ShouldMatchPersonsCount()
        ...
        List<Person> list = addressBookService.readAddressBookData(AddressBookService.IOService.DB_IO, "2020-11-01", "2020-11-22");
        Assert.assertEquals(2, list.size());
    }
    ...
    public void givenPersons_WhenAddedToDBUsingThread_ShouldMatchNumOfEntries() throws AddressBookException {
        ...
        Assert.assertEquals(3, addressBookService.countEntries(AddressBookService.IOService.DB_IO));
    }
}
